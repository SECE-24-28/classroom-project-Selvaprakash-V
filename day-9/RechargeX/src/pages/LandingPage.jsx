...
import { FiZap, FiShield, FiBarChart2, FiMessageCircle, FiSmartphone, FiTv, FiFileText, FiWifi, FiStar, FiUsers, FiClock, FiAward } from 'react-icons/fi';
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4 pt-8">
                  <div className="rounded-2xl overflow-hidden shadow-xl bg-gray-900 dark:bg-gray-800 p-6 text-white">
                    <FiZap className="w-10 h-10 mb-3 text-orange-400" />
