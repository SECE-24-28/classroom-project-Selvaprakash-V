import { FiCheck, FiZap, FiWifi, FiCalendar, FiGift } from 'react-icons/fi';
...
const PlanCard = ({
  ...
  // API Schema: { PlanName, Price, Data, Validity, AddOns, id }
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="flex items-center gap-2 text-gray-600 dark:text-gray-300">
              ...
              <span>{Data > 0 ? `${Data} GB/Day` : 'No Data'}</span>
            </div>
          </div>
