        ...
        {plans.map((plan) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <h4 className="text-2xl font-bold text-orange-600 dark:text-orange-400">₹{plan.price}</h4>
              <span className="text-sm bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300 px-3 py-1 rounded-lg font-medium">{plan.provider}</span>
            </div>
            ...
            <div className="flex items-start gap-2 text-gray-500 dark:text-gray-500">
              ...
              <p className="text-xs">{plan.planName} {plan.addOns && `- ${plan.addOns}`}</p>
            </div>
          </div>
        ))}
      </div>
