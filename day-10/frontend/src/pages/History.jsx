...
import { FiPhone, FiCalendar, FiFilter, FiDownload, FiCheckCircle, FiXCircle, FiClock, FiSearch, FiZap } from 'react-icons/fi';
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        {transaction.operator} • {transaction.circle}
                      </p>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        {transaction.planName} • {transaction.validity}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:items-end gap-2">
                    ...
                    <div className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(transaction.status)}`}>
