...
import { FiZap, FiClock, FiCreditCard, FiTrendingUp, FiArrowRight, FiPhone, FiSmile } from 'react-icons/fi';
...
const Dashboard = () => {
  ...
  // Use useMemo to compute transactions and stats
  const { recentTransactions, stats } = useMemo(() => {
    ...
    return {
      ...
      stats: {
        ...
        totalSpent,
        lastRecharge: userTransactions[0]?.date || null,
      }
    };
  }, [user]);
