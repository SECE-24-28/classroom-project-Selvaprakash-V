...
import { FiMenu, FiX, FiLogOut, FiUser, FiHome, FiZap, FiClock, FiSettings } from 'react-icons/fi';
...
const Navbar = () => {
  ...
  const userLinks = [
    ...
    { to: '/recharge', label: 'Recharge', icon: FiZap },
  ...
  const adminLinks = [
    ...
    { to: '/admin/plans', label: 'Manage Plans', icon: FiZap },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            >
              <FiZap className="h-8 w-8 text-orange-500" />
